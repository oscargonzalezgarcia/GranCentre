 ...
 * Use the {@link ItaliaFragment#newInstance} factory method to
...
public class ItaliaFragment extends Fragment implements View.OnClickListener {
    ...
    ItaliaFragment.onClickItaliaListener listener ;
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if (context instanceof ItaliaFragment.onClickItaliaListener){
            listener= (ItaliaFragment.onClickItaliaListener) context;
        } else {
    ...
    public static ItaliaFragment newInstance(String param1, String param2) {
        ItaliaFragment fragment = new ItaliaFragment();
    ...
    public void onClick(View v) {
        listener.onClickItalia(v);
    }
    public interface onClickItaliaListener {
        void onClickItalia(View v);
    }
}